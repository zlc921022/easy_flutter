class ApiService {
  /// 正在热映接口 {参数：start 和 count}
  static String getNowPlayingList() {
    return 'in_theaters';
  }

  /// 即将上映电影接口 {参数：start 和 count}
  static String getComingSoon() {
    return 'coming_soon';
  }
  ...
  ///  获取 top250 榜单 {参数：start 和 count}
  static String getTop250() {
    return 'top250';
  }

  /// 根据标签搜索 {参数：tag，start 和 count}
  static String searchByTag() {
    return 'search';
  }

  /// 根据关键字搜索 {参数：key，start 和 count}
